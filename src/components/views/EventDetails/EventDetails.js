...
const EventDetails = props => {
  ...
  return(
    <div className={styles.component}>
	  <Paper className={styles.component}><Typography variant='h5' component='h5' align='center' className={styles.title}>Event details:{demoContent.map(booking => booking.id == match.params.id?' id = ' + booking.id
        :'')}</Typography>
      <form>
